export type Lang = "en" | "de" | "ru" | "fr" | "es" | "it";
...
export const DICT: Record<Lang, Dict> = {
  en: {
    ...
    lowerNeutralBody:
      "CarrierTrust hosts user-generated reviews and applies traceable moderation for legal and policy breaches.",
    lowerBusinessTitle: "Business-first",
    lowerBusinessBody:
      "Reviews focus on real business experience. Companies can claim their profile and respond publicly.",
    lowerEuTitle: "EU-focused trust layer",
    lowerEuBody:
      "Designed for cross-border transport where reputation, compliance and dispute traceability matter.",
    ...
    how1Body:
      "Find a company by name or VAT. Verified profiles reduce identity ambiguity.",
    how2Title: "Publish real experience",
    how2Body:
      "Structured reviews focused on facts, outcomes, and cooperation quality.",
    how3Title: "Traceable moderation",
    how3Body:
      "Clear rules and audit-ready actions for disputes, edits, and removals.",

    sectionSignalsTitle: "Trust signals that matter",
    sectionSignalsSub:
      "Built for cross-border operations — not generic consumer reviews.",
    sig1Title: "Verified identity",
    sig1Body:
      "Company verification and profile ownership reduce fake listings and impersonation.",
    sig2Title: "Moderation trace",
    sig2Body:
      "Moderation actions are recorded. Clear policy and predictable enforcement.",
    sig3Title: "Dispute readiness",
    sig3Body:
      "Designed to support dispute workflows without turning into a court.",

    sectionCompaniesTitle: "For companies",
    sectionCompaniesSub:
      "Tools to protect reputation, respond professionally, and stay transparent.",
    companies1Title: "Claim & manage profile",
    companies1Body:
      "Own your presence, add details, and respond to reviews publicly.",
    companies2Title: "Verified badge",
    companies2Body:
      "Signal trust and reduce friction with partners in Europe.",

    sectionFAQTitle: "FAQ",
    faq1Q: "Can anyone post reviews?",
    faq1A:
      "Reviews are designed for real business relationships. We focus on traceable moderation and policy compliance.",
    faq2Q: "Do you remove negative reviews?",
    faq2A:
      "We remove content that violates policy or law — not content that is simply negative.",
    faq3Q: "Is this available across the EU?",
    faq3A:
      "Yes — the platform is built EU-first and focuses on cross-border transport & logistics.",

    sectionCTAHeadline: "Build trust before the next load.",
    sectionCTASub:
      "Search a company or publish a real business review — in minutes.",
    ...
    orbitExcellentReview:
      "Perfect delivery! On time, professional drivers, great communication.",
    orbitGoodReview:
...
howToUseRiskIndexBody:
  "Risk index helps identify logistics companies with elevated fraud signals, abnormal review patterns, or trust instability.",
...
tipReply:
  "Tip: Calm, factual replies and clear resolution steps help build trust over time.",
  },
  ...
  de: {
    ...
    lowerNeutralBody:
      "CarrierTrust hostet nutzergenerierte Bewertungen und wendet nachvollziehbare Moderation bei rechtlichen und policy-relevanten Verstößen an.",
    lowerBusinessTitle: "Geschäftsorientiert",
    lowerBusinessBody:
      "Bewertungen basieren auf echter Geschäftserfahrung. Unternehmen können ihr Profil beanspruchen und öffentlich antworten.",
    lowerEuTitle: "EU-orientierte Vertrauensebene",
    lowerEuBody:
      "Entwickelt für grenzüberschreitenden Transport, wo Reputation, Compliance und Nachvollziehbarkeit von Streitfällen wichtig sind.",
    ...
    how1Body:
      "Finde ein Unternehmen per Name oder VAT. Verifizierte Profile reduzieren Identitätsverwechslungen.",
    how2Title: "Echte Erfahrung veröffentlichen",
    how2Body:
      "Strukturierte Bewertungen mit Fokus auf Fakten, Ergebnisse und Qualität der Zusammenarbeit.",
    how3Title: "Nachvollziehbare Moderation",
    how3Body:
      "Klare Regeln und auditfähige Maßnahmen für Streitfälle, Bearbeitungen und Entfernungen.",

    sectionSignalsTitle: "Vertrauenssignale, die zählen",
    sectionSignalsSub:
      "Entwickelt für grenzüberschreitende Abläufe — keine generischen Verbraucherbewertungen.",
    sig1Title: "Verifizierte Identität",
    sig1Body:
      "Unternehmensverifizierung und Profilbesitz reduzieren Fake-Listings und Identitätsmissbrauch.",
    sig2Title: "Moderationshistorie",
    sig2Body:
      "Moderationsmaßnahmen werden protokolliert. Klare Regeln und vorhersehbare Durchsetzung.",
    sig3Title: "Streitfall-Bereitschaft",
    sig3Body:
      "Entwickelt zur Unterstützung von Streitfällen, ohne zu einem Gericht zu werden.",

    sectionCompaniesTitle: "Für Unternehmen",
    sectionCompaniesSub:
      "Tools, um Reputation zu schützen, professionell zu antworten und transparent zu bleiben.",
    companies1Title: "Profil beanspruchen & verwalten",
    companies1Body:
      "Übernimm deine Präsenz, ergänze Details und antworte öffentlich auf Bewertungen.",
    companies2Title: "Verifiziertes Badge",
    companies2Body:
      "Signalisiere Vertrauen und reduziere Reibung mit Partnern in Europa.",

    sectionFAQTitle: "FAQ",
    faq1Q: "Kann jeder Bewertungen abgeben?",
    faq1A:
      "Bewertungen sind für echte Geschäftsbeziehungen gedacht. Wir setzen auf nachvollziehbare Moderation und Regelkonformität.",
    faq2Q: "Entfernen Sie negative Bewertungen?",
    faq2A:
      "Wir entfernen Inhalte nur bei Verstößen gegen Regeln oder Gesetze — nicht, weil sie negativ sind.",
    faq3Q: "Ist das in der gesamten EU verfügbar?",
    faq3A:
      "Ja — die Plattform ist EU-first aufgebaut und auf grenzüberschreitenden Transport & Logistik ausgerichtet.",

    sectionCTAHeadline: "Vertrauen vor der nächsten Ladung aufbauen.",
    sectionCTASub:
      "Suche ein Unternehmen oder veröffentliche in wenigen Minuten eine echte Geschäftsbewertung.",
    ...
    orbitExcellentReview:
      "Perfekte Lieferung! Pünktlich, professionelle Fahrer, großartige Kommunikation.",
    orbitGoodReview:
      "Insgesamt guter Service. Kleine Verzögerung, aber professionell gelöst.",
    orbitBadReview:
...
howToUseRiskIndexBody:
  "Der Risikoindex hilft dabei, Logistikunternehmen mit erhöhten Betrugssignalen oder instabilen Vertrauensmustern zu erkennen.",
...
tipReply:
  "Tipp: Ruhige, sachliche Antworten schaffen langfristig Vertrauen.",
  },
  ...
  ru: {
    ...
    lowerNeutralBody:
      "CarrierTrust размещает пользовательские отзывы и применяет прозрачную модерацию при нарушениях правил и закона.",
    lowerBusinessTitle: "Фокус на бизнесе",
    lowerBusinessBody:
      "Отзывы основаны на реальном бизнес-опыте. Компании могут подтвердить профиль и отвечать публично.",
    lowerEuTitle: "Доверие для ЕС",
    lowerEuBody:
      "Создано для трансграничной логистики, где важны репутация, compliance и фиксация спорных кейсов.",
    ...
    how1Body:
      "Ищи компанию по названию или VAT. Подтверждённые профили снижают путаницу с идентичностью.",
    how2Title: "Публикуй реальный опыт",
    how2Body:
      "Структурированные отзывы с фокусом на факты, результат и качество сотрудничества.",
    how3Title: "Прозрачная модерация",
    how3Body:
      "Понятные правила и фиксируемые действия по спорам, правкам и удалению.",

    sectionSignalsTitle: "Сигналы доверия, которые важны",
    sectionSignalsSub:
      "Сделано для международной логистики, а не для обычных потребительских отзывов.",
    sig1Title: "Проверенная идентичность",
    sig1Body:
      "Верификация компании и владение профилем снижают риск фейков и подмены.",
    sig2Title: "След модерации",
    sig2Body:
      "Действия модерации фиксируются. Ясные правила и предсказуемое применение.",
    sig3Title: "Готовность к спорам",
    sig3Body:
      "Платформа помогает в спорных кейсах, но не превращается в суд.",

    sectionCompaniesTitle: "Для компаний",
    sectionCompaniesSub:
      "Инструменты для защиты репутации, публичных ответов и прозрачного присутствия.",
    companies1Title: "Подтвердить и управлять профилем",
    companies1Body:
      "Контролируй своё присутствие, добавляй данные и отвечай на отзывы публично.",
    companies2Title: "Знак верификации",
    companies2Body:
      "Показывай надёжность и снижай трение с партнёрами по Европе.",

    sectionFAQTitle: "FAQ",
    faq1Q: "Кто может оставить отзыв?",
    faq1A:
      "Отзывы предназначены для реальных деловых отношений. Мы делаем упор на прозрачную модерацию и соблюдение правил.",
    faq2Q: "Удаляете ли вы негативные отзывы?",
    faq2A:
      "Мы удаляем только то, что нарушает правила или закон — а не просто негатив.",
    faq3Q: "Это работает по всему ЕС?",
    faq3A:
      "Да — платформа создавалась как EU-first решение для трансграничной логистики.",

    sectionCTAHeadline: "Построй доверие до следующей перевозки.",
    sectionCTASub:
      "Найди компанию или опубликуй реальный бизнес-отзыв за пару минут.",
    ...
    orbitExcellentReview:
      "Идеальная доставка! Всё вовремя, профессиональные водители, отличная коммуникация.",
    orbitGoodReview:
      "В целом хороший сервис. Небольшая задержка, но решено профессионально.",
    orbitBadReview:
...
howToUseRiskIndexBody:
  "Индекс риска помогает выявлять логистические компании с повышенными признаками мошенничества и нестабильным доверием.",
...
tipReply:
  "Совет: спокойные и точные ответы постепенно укрепляют доверие.",
  },
  ...
  fr: {
    ...
    lowerNeutralBody:
      "CarrierTrust héberge les avis générés par les utilisateurs et applique une modération traçable pour les violations juridiques et de politique.",
    lowerBusinessTitle: "Orienté business",
    lowerBusinessBody:
      "Les avis se concentrent sur l’expérience commerciale réelle. Les entreprises peuvent revendiquer leur profil et répondre publiquement.",
    lowerEuTitle: "Couche de confiance orientée UE",
    lowerEuBody:
      "Conçu pour le transport transfrontalier où réputation, conformité et traçabilité des litiges comptent.",
    ...
    how1Body:
      "Trouvez une entreprise par nom ou numéro TVA. Les profils vérifiés réduisent l’ambiguïté d’identité.",
    how2Title: "Publier une vraie expérience",
    how2Body:
      "Avis structurés axés sur les faits, les résultats et la qualité de la coopération.",
    how3Title: "Modération traçable",
    how3Body:
      "Règles claires et actions auditables pour les litiges, modifications et suppressions.",

    sectionSignalsTitle: "Des signaux de confiance qui comptent",
    sectionSignalsSub:
      "Conçu pour les opérations transfrontalières — pas pour de simples avis consommateurs.",
    sig1Title: "Identité vérifiée",
    sig1Body:
      "La vérification de l’entreprise et la propriété du profil réduisent les faux profils et l’usurpation.",
    sig2Title: "Trace de modération",
    sig2Body:
      "Les actions de modération sont enregistrées. Politique claire et application prévisible.",
    sig3Title: "Prêt pour les litiges",
    sig3Body:
      "Conçu pour soutenir les flux de litige sans devenir un tribunal.",

    sectionCompaniesTitle: "Pour les entreprises",
    sectionCompaniesSub:
      "Des outils pour protéger la réputation, répondre professionnellement et rester transparents.",
    companies1Title: "Revendiquer et gérer le profil",
    companies1Body:
      "Prenez le contrôle de votre présence, ajoutez des détails et répondez publiquement aux avis.",
    companies2Title: "Badge vérifié",
    companies2Body:
      "Montrez la confiance et réduisez la friction avec les partenaires en Europe.",

    sectionFAQTitle: "FAQ",
    faq1Q: "Tout le monde peut-il publier un avis ?",
    faq1A:
      "Les avis sont conçus pour de vraies relations commerciales. Nous mettons l’accent sur une modération traçable et la conformité aux règles.",
    faq2Q: "Supprimez-vous les avis négatifs ?",
    faq2A:
      "Nous supprimons les contenus qui violent les règles ou la loi — pas ceux qui sont simplement négatifs.",
    faq3Q: "Est-ce disponible dans toute l’UE ?",
    faq3A:
      "Oui — la plateforme est conçue d’abord pour l’UE et se concentre sur le transport et la logistique transfrontaliers.",

    sectionCTAHeadline: "Construisez la confiance avant le prochain chargement.",
    sectionCTASub:
      "Recherchez une entreprise ou publiez un vrai avis commercial en quelques minutes.",
    ...
    orbitExcellentReview:
      "Livraison parfaite ! À l’heure, chauffeurs professionnels, excellente communication.",
    orbitGoodReview:
      "Bon service dans l’ensemble. Petit retard mais géré de façon professionnelle.",
    orbitBadReview:
...
howToUseRiskIndexBody:
  "L’indice aide à identifier les entreprises logistiques présentant des signaux de fraude élevés.",
...
tipReply:
  "Conseil : des réponses calmes, factuelles et claires renforcent la confiance avec le temps.",
  },
  ...
  es: {
    ...
    lowerNeutralBody:
      "CarrierTrust aloja reseñas generadas por usuarios y aplica moderación trazable para infracciones legales y de políticas.",
    lowerBusinessTitle: "Enfocado al negocio",
    lowerBusinessBody:
      "Las reseñas se centran en experiencia comercial real. Las empresas pueden reclamar su perfil y responder públicamente.",
    lowerEuTitle: "Capa de confianza para la UE",
    lowerEuBody:
      "Diseñado para transporte transfronterizo donde reputación, cumplimiento y trazabilidad de disputas importan.",
    ...
    how1Body:
      "Encuentra una empresa por nombre o VAT. Los perfiles verificados reducen la ambigüedad de identidad.",
    how2Title: "Publicar experiencia real",
    how2Body:
      "Reseñas estructuradas centradas en hechos, resultados y calidad de cooperación.",
    how3Title: "Moderación trazable",
    how3Body:
      "Reglas claras y acciones auditables para disputas, ediciones y eliminaciones.",

    sectionSignalsTitle: "Señales de confianza que importan",
    sectionSignalsSub:
      "Creado para operaciones transfronterizas — no para reseñas genéricas de consumo.",
    sig1Title: "Identidad verificada",
    sig1Body:
      "La verificación de empresa y la propiedad del perfil reducen listados falsos y suplantación.",
    sig2Title: "Rastro de moderación",
    sig2Body:
      "Las acciones de moderación se registran. Política clara y aplicación predecible.",
    sig3Title: "Listo para disputas",
    sig3Body:
      "Diseñado para apoyar flujos de disputa sin convertirse en un tribunal.",

    sectionCompaniesTitle: "Para empresas",
    sectionCompaniesSub:
      "Herramientas para proteger la reputación, responder profesionalmente y mantener transparencia.",
    companies1Title: "Reclamar y gestionar perfil",
    companies1Body:
      "Controla tu presencia, añade detalles y responde públicamente a las reseñas.",
    companies2Title: "Insignia verificada",
    companies2Body:
      "Muestra confianza y reduce fricción con socios en Europa.",

    sectionFAQTitle: "FAQ",
    faq1Q: "Cualquiera puede publicar reseñas?",
    faq1A:
      "Las reseñas están pensadas para relaciones comerciales reales. Nos centramos en moderación trazable y cumplimiento de políticas.",
    faq2Q: "Eliminan reseñas negativas?",
    faq2A:
      "Eliminamos contenido que viola las reglas o la ley — no contenido simplemente negativo.",
    faq3Q: "Está disponible en toda la UE?",
    faq3A:
      "Sí — la plataforma está construida con enfoque UE y se centra en transporte y logística transfronterizos.",

    sectionCTAHeadline: "Construye confianza antes de la próxima carga.",
    sectionCTASub:
      "Busca una empresa o publica una reseña comercial real en minutos.",
    ...
    orbitExcellentReview:
      "¡Entrega perfecta! A tiempo, conductores profesionales, gran comunicación.",
    orbitGoodReview:
      "Buen servicio en general. Pequeño retraso, pero gestionado profesionalmente.",
    orbitBadReview:
      "Factura vencida 45 días. La carga fue entregada pero no se recibió el pago.",

      riskIndexTitle: "Índice de riesgo empresarial",
      browseCompaniesDirectory: "Directorio de empresas",
riskIndexDesc:
...
howToUseRiskIndexBody:
  "El índice ayuda a identificar empresas logísticas con señales elevadas de fraude.",
...
tipReply:
  "Consejo: respuestas tranquilas, claras y basadas en hechos ayudan a generar confianza con el tiempo.",
  },
  ...
  it: {
    ...
    lowerNeutralBody:
      "CarrierTrust ospita recensioni generate dagli utenti e applica moderazione tracciabile per violazioni legali e di policy.",
    lowerBusinessTitle: "Orientato al business",
    lowerBusinessBody:
      "Le recensioni si concentrano su esperienza aziendale reale. Le aziende possono rivendicare il profilo e rispondere pubblicamente.",
    lowerEuTitle: "Livello di fiducia orientato UE",
    lowerEuBody:
      "Progettato per il trasporto transfrontaliero dove reputazione, compliance e tracciabilità delle dispute contano.",
    ...
    how1Body:
      "Trova un’azienda per nome o VAT. I profili verificati riducono l’ambiguità di identità.",
    how2Title: "Pubblica esperienza reale",
    how2Body:
      "Recensioni strutturate focalizzate su fatti, risultati e qualità della collaborazione.",
    how3Title: "Moderazione tracciabile",
    how3Body:
      "Regole chiare e azioni verificabili per dispute, modifiche e rimozioni.",

    sectionSignalsTitle: "Segnali di fiducia che contano",
    sectionSignalsSub:
      "Creato per operazioni transfrontaliere — non per recensioni consumer generiche.",
    sig1Title: "Identità verificata",
    sig1Body:
      "La verifica aziendale e la proprietà del profilo riducono falsi elenchi e impersonificazione.",
    sig2Title: "Traccia di moderazione",
    sig2Body:
      "Le azioni di moderazione vengono registrate. Policy chiara e applicazione prevedibile.",
    sig3Title: "Pronto per le dispute",
    sig3Body:
      "Progettato per supportare i flussi di disputa senza diventare un tribunale.",

    sectionCompaniesTitle: "Per le aziende",
    sectionCompaniesSub:
      "Strumenti per proteggere la reputazione, rispondere professionalmente e restare trasparenti.",
    companies1Title: "Rivendica e gestisci il profilo",
    companies1Body:
      "Controlla la tua presenza, aggiungi dettagli e rispondi pubblicamente alle recensioni.",
    companies2Title: "Badge verificato",
    companies2Body:
      "Mostra fiducia e riduci attrito con i partner in Europa.",

    sectionFAQTitle: "FAQ",
    faq1Q: "Chiunque può pubblicare recensioni?",
    faq1A:
      "Le recensioni sono pensate per veri rapporti commerciali. Ci concentriamo su moderazione tracciabile e conformità alle regole.",
    faq2Q: "Rimuovete recensioni negative?",
    faq2A:
      "Rimuoviamo contenuti che violano regole o legge — non contenuti semplicemente negativi.",
    faq3Q: "È disponibile in tutta l’UE?",
    faq3A:
      "Sì — la piattaforma è costruita con approccio UE-first e si concentra su trasporto e logistica transfrontalieri.",

    sectionCTAHeadline: "Costruisci fiducia prima del prossimo carico.",
    sectionCTASub:
      "Cerca un’azienda o pubblica una recensione aziendale reale in pochi minuti.",
    ...
    orbitExcellentReview:
      "Consegna perfetta! Puntuale, autisti professionali, ottima comunicazione.",
    orbitGoodReview:
      "Buon servizio nel complesso. Piccolo ritardo, ma gestito in modo professionale.",
    orbitBadReview:
...
howToUseRiskIndexBody:
  "L’indice aiuta a identificare aziende logistiche con segnali elevati di frode.",
...
tipReply:
  "Suggerimento: risposte calme, chiare e basate sui fatti aiutano a costruire fiducia nel tempo.",
  },
};
