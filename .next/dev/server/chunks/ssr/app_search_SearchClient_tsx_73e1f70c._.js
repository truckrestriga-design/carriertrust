module.exports = [
"[project]/app/search/SearchClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SearchPage() {
    ...
    const [searchValue, setSearchValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(q);
    ...
    const searchSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadBanners() {
            const now = new Date();
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("banners").select("id, image_url, alt, placement, is_active, sort_order, expires_at").eq("is_active", true).in("placement", [
                "search_left",
                "search_right"
            ]).order("sort_order", {
                ascending: true
            ...
            const left = rows.filter((item)=>item.placement === "search_left").map((item)=>({
                    id: item.id,
                    image: item.image_url,
                    alt: item.alt || "Left banner"
                }));
            const right = rows.filter((item)=>item.placement === "search_right").map((item)=>({
                    id: item.id,
                    image: item.image_url,
...
//# sourceMappingURL=app_search_SearchClient_tsx_73e1f70c._.js.map