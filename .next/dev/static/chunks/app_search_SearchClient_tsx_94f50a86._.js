...
"[project]/app/search/SearchClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const EN = {
    ...
    queryLabel: "Query",
    searchPlaceholder: "Search another company...",
    searchButton: "Search",
    loading: "Loading...",
...
const TEXT = {
    ...
    de: {
        ...
        searchPlaceholder: "Nach einer anderen Firma suchen...",
        searchButton: "Suchen",
        loading: "Lädt...",
    ...
    ru: {
        ...
        queryLabel: "Запрос",
        searchPlaceholder: "Найти другую компанию...",
        searchButton: "Искать",
        loading: "Загрузка...",
        ...
        searchPageLabel: "Страница поиска",
        sideLabel: "Сторона",
        sideLeft: "левая",
        sideRight: "правая",
        sizeLabel: "Размер",
    ...
    fr: {
        ...
        queryLabel: "Requête",
        searchPlaceholder: "Rechercher une autre société...",
        ...
        searchPageLabel: "Page de recherche",
        sideLabel: "Côté",
        sideLeft: "gauche",
        sideRight: "droite",
        sizeLabel: "Taille",
    ...
    es: {
        ...
        queryLabel: "Consulta",
        searchPlaceholder: "Buscar otra empresa...",
        searchButton: "Buscar",
        loading: "Cargando...",
        ...
        searchPageLabel: "Página de búsqueda",
        sideLabel: "Lado",
        sideLeft: "izquierdo",
        sideRight: "derecho",
        sizeLabel: "Tamaño",
    ...
    it: {
        ...
        queryLabel: "Query",
        searchPlaceholder: "Cerca un’altra azienda...",
        searchButton: "Cerca",
        loading: "Caricamento...",
        ...
        searchPageLabel: "Pagina di ricerca",
        sideLabel: "Lato",
        sideLeft: "sinistro",
        sideRight: "destro",
...
function SearchPage() {
    ...
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchPage.useMemo[t]": ()=>TEXT[lang || "en"] ?? TEXT.en
    }["SearchPage.useMemo[t]"], [
        lang
    ]);
    const [searchValue, setSearchValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(q);
    ...
    const translatedPricing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchPage.useMemo[translatedPricing]": ()=>{
            return pricing.map({
                "SearchPage.useMemo[translatedPricing]": (plan)=>{
    ...
    const companyBankData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchPage.useMemo[companyBankData]": ()=>({
                companyName: 'SIA "JAKOVLEV CAPITAL"',
                accountNumber: "LV00HABA0000000000000",
                bic: "HABALV22"
            })
    }["SearchPage.useMemo[companyBankData]"], []);
    const paymentPurpose = form.companyName.trim() ? `Banner - ${form.companyName.trim()}` : t.paymentPurposeFallback;
    ...
    const searchSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchPage.useMemo[searchSchema]": ()=>{
            const pageUrl = q ? `https://carriertrust.eu/search?q=${encodeURIComponent(q)}` : "https://carriertrust.eu/search";
            const schema = {
                "@context": "https://schema.org",
                "@type": "SearchResultsPage",
                name: q ? `${t.pageTitle}: ${q}` : t.pageTitle,
                url: pageUrl,
                isPartOf: {
                    "@type": "WebSite",
                    name: "CarrierTrust",
            ...
            if (q) {
                schema.mainEntity = {
                    ...
                    itemListElement: items.map({
                        "SearchPage.useMemo[searchSchema]": (item, index)=>({
                                "@type": "ListItem",
                                position: index + 1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchPage.useEffect": ()=>{
            async function loadCompanies() {
                ...
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("companies").select("id, slug, name, vat_uid, country").ilike("name", `%${query}%`).order("name", {
                    ascending: true
                }).limit(50);
                const companies = data || [];
                const companyIds = companies.map({
                    "SearchPage.useEffect.loadCompanies.companyIds": (x)=>x.id
                }["SearchPage.useEffect.loadCompanies.companyIds"]).filter(Boolean);
                let merged = companies;
                if (companyIds.length > 0) {
                    const { data: plansData, error: plansError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("company_plans").select("company_id, plan, plan_status, current_period_end").in("company_id", companyIds);
                    ...
                    if (!plansError && plansData) {
                        ...
                        merged = companies.map({
                            "SearchPage.useEffect.loadCompanies": (company)=>{
                        ...
                        }["SearchPage.useEffect.loadCompanies"]);
                    }
                }
                if (error) {
                ...
                console.log("MERGED SEARCH ITEMS JSON", JSON.stringify(merged.map({
                    "SearchPage.useEffect.loadCompanies": (x)=>({
                            id: x.id,
                            name: x.name,
                ...
                }["SearchPage.useEffect.loadCompanies"]), null, 2));
                setItems(merged);
                setLoading(false);
            }
            loadCompanies();
        ...
        "SearchPage.useEffect": ()=>{
            async function loadBanners() {
                ...
                const rows = (data || []).filter({
                    "SearchPage.useEffect.loadBanners.rows": (item)=>{
                        if (!item.expires_at) return true;
                        return new Date(item.expires_at) > now;
                    }
                }["SearchPage.useEffect.loadBanners.rows"]);
                const left = rows.filter({
                    "SearchPage.useEffect.loadBanners.left": (item)=>item.placement === "search_left"
                }["SearchPage.useEffect.loadBanners.left"]).map({
                    "SearchPage.useEffect.loadBanners.left": (item)=>({
                            id: item.id,
                            image: item.image_url,
                            alt: item.alt || "Left banner"
                        })
                }["SearchPage.useEffect.loadBanners.left"]);
                const right = rows.filter({
                    "SearchPage.useEffect.loadBanners.right": (item)=>item.placement === "search_right"
                }["SearchPage.useEffect.loadBanners.right"]).map({
                    "SearchPage.useEffect.loadBanners.right": (item)=>({
                            id: item.id,
                            image: item.image_url,
                            alt: item.alt || "Right banner"
                        })
                }["SearchPage.useEffect.loadBanners.right"]);
                setLeftBanners(left);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchPage.useEffect": ()=>{
            ...
            }["SearchPage.useEffect.timer"], 2500);
            return ({
    ...
    function handleSearch() {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trackEvent"])({
            event_type: "search",
            search_query: value,
            page_path: `/search?q=${encodeURIComponent(value)}`
        });
    ...
    async function handleSubmitPaid() {
        ...
        try {
            ...
            body.append("placement", selectedSide === "left" ? "search_left" : "search_right");
            ...
            setSubmitError(error instanceof Error ? error.message : t.errorSending);
        } finally{
            setSubmitting(false);
        }
    }
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "relative overflow-hidden rounded-[2rem] border border-white/60 bg-white/70 p-6 shadow-[0_25px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl md:p-8",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "mt-4 text-sm leading-7 text-slate-600 md:text-[15px]",
                                                    children: [
                                                        t.queryLabel,
                                                        ": ",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "relative flex flex-col gap-3 rounded-2xl border border-slate-100 bg-white p-2 shadow-xl shadow-slate-200/40 md:flex-row md:items-center",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        ...
                                                                        className: "rounded-xl bg-slate-900 px-6 py-3 font-semibold text-white shadow-lg shadow-slate-900/20 transition-all hover:scale-[1.02] hover:bg-slate-800",
                                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-8 rounded-[1.5rem] border border-slate-200/70 bg-white/80 p-4 shadow-sm md:p-5",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                ":",
                                                " ",
                                                selectedSide === "left" ? t.sideLeft : t.sideRight,
                                                " • ",
                                                t.sizeLabel,
                                                " 180×600px"
                                            ]
...
_s1(SearchPage, "zxgIIijVlf+CbxDHDHcPTxZe9XI=", false, function() {
    return [
...
//# sourceMappingURL=app_search_SearchClient_tsx_94f50a86._.js.map