...
export default function HomeClient({
  ...
  initialPublishedReviewsCount,
}: {
  initialCompaniesCount: number;
  initialPublishedReviewsCount: number;
}) {
  const { t } = useLang();
  ...
  const companiesCount = initialCompaniesCount;
  const publishedReviewsCount = initialPublishedReviewsCount;
